 ...
 * @author Paul
 */
public class Consultar_criteriosController extends Concurso_mascotasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (Criteria criteria : criteria_list) {
            Label label_criteria = new Label(criteria.toString());
            vbox_consultas.getChildren().add(label_criteria);
        }
