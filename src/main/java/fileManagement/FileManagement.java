...
public class FileManagement {
    ...
    public static Owner getOwnerByEmail(ArrayList<Owner> owners, String email){
        ...
        System.out.println("No existe un dueño con ese email");
        return null;
    }
    ...
    public static ArrayList<Pet> readpets(String filename, ArrayList<Owner> owners){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(yourFile))){
            while(br.ready()){
                ...
                if(o!=null){
                    ...
                    System.out.println("No se pudo añadir esta mascota");
                }
            }
        } catch (FileNotFoundException ex) {
            Logger.getLogger(FileManagement.class.getName()).log(Level.SEVERE, null, ex);
     ...
     public static Contest getContestByID(ArrayList<Contest> contests, String ID){
        ...
        System.out.println("No existe un concurso con ese ID");
        return null;
    }
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(yourFile))){
            while(br.ready()){
                ...
                prizes.add(prize);
                    ...
                    System.out.println("No se pudo añadir este premio");
                }
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(yourFile))){
            while(br.ready()){
                ...
                criterias.add(criteria);
                    ...
                    System.out.println("No se pudo añadir este criterio");
                }
            ...
            while(br.ready()){
                ...
                if(contest!=null && pet!=null){
                  ...
                  inscriptions.add(inscription);
                    ...
                    System.out.println("No se pudo añadir esta inscripción");
                }
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(yourFile))){
            while(br.ready()){
                ...
                judges.add(judge);
                    ...
                    System.out.println("No se pudo añadir este concurso");
                }
    ...
    public static Judge getJudgeByemail(ArrayList<Judge> judges, String email){
        ...
        System.out.println("No existe un miembro del jurado con ese nombre");
        return null;
    }
    public static Inscription getInscriptionByID(ArrayList<Inscription> inscriptions, String ID){
        ...
        System.out.println("No existe una inscripción con ese ID");
        return null;
    }
    public static Criteria getCriteriaByID(ArrayList<Criteria> criterias, String ID){
        ...
        System.out.println("No existe un criterio con ese ID");
        return null;
    }
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(yourFile))){
            while(br.ready()){
                ...
                evaluations.add(evaluation);
                    ...
                    System.out.println("No se pudo añadir esta evaluación");
                }
